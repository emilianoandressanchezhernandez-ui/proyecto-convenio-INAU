...
| Primera versión | Autenticación por rol, gestión de usuarios y talleres (incluyendo consulta de datos sensibles y del listado de alumnos por taller), registro y consulta de asistencia, carga/entrega/corrección/eliminación de material y tareas, reportes de asistencia/talleres/alumnos/talleristas, gestión de perfil, comunicación asincrónica tallerista-alumno. |
...
| HU21 | EP7 | RF19 | Como tallerista, quiero comunicarme de forma asincrónica con los alumnos de mi taller, para resolver dudas o dar avisos sin necesidad de coincidir en línea al mismo tiempo. | 5 | Baja |